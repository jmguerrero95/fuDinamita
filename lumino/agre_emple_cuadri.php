...
$info3=$datos2->consulta_general_agrecuadri();
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="clientes.php"><em class="fa fa-user">&nbsp;</em> Cliente</a></li>
						...
						<table class="table" id="tabla">
								...
								<form action="../include/acciones_espe.php" method="POST">
									<tr>
										<td class="mdl-data-table__cell--non-numeric">
											<input size="13" class="form-control" type="text" name="cod_cuadri" value="<?php echo $info[0][0] ?>">
										</td>
										<td class="mdl-data-table__cell--non-numeric">
											<input size="13" class="form-control" type="text" name="nombre" value="<?php echo $nombre ?>">
										</td>
										<td class="mdl-data-table__cell--non-numeric">
											<input size="13" class="form-control" type="text" name="cedu_jefe" value="<?php echo $cedu_jefe ?>">
										</td>
										<td class="mdl-data-table__cell--non-numeric">
							...
							<form action="../include/agre_emple_cuadri.php" method="POST">
								<table class="table" id="tabla">
									...
									<tr>
										<td class="mdl-data-table__cell--non-numeric">
											<input class="input-group" type="checkbox" name="<?php echo $i?>" value="<?php echo $info3[$i][0]?>">
										</td>
										<td class="mdl-data-table__cell--non-numeric">
											<?php echo $info3[$i][0] ?>
										</td>
								...
								<br>
								<button type="submit" name="guardar" class="btn btn-primary" value="a">Guardar seleccion</button>
								</form> 
					</div>
				</div>
