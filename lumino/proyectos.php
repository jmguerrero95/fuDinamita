...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="proyectos.php"><em class="fa fa-suitcase">&nbsp;</em> Proyectos</a></li>
...
<div id="info" class="mdl-cell mdl-cell--12-col" style="display: none"></div>
					<div class="container-fluid center-block">
						<div id="info_parcial" class="table-responsive col-lg-6 col-md-offset-3">
						...
						<?php
							$datos = new SoapClient(null,array('location'=>'http://127.0.0.1/servicio_dinamita/cuadrilla.php','uri'=>'urn:cuadrilla',));
							for ($i=0; $i < $aux; $i++) {
							$info2=$datos->datos_emple_cuadri($info[$i][3]);
							$aux2=count($info2); 
						?>
								
									<tr>
										<td class="mdl-data-table__cell--non-numeric">
											<input size="13" class="form-control input-sm" type="hidden" name="cod_cuadri" value="<?php echo $info[$i][3] ?>">
											<?php echo $info[$i][3] ?>
										</td>
										<td class="mdl-data-table__cell--non-numeric">
											<input size="13" class="form-control input-sm" type="hidden" name="nombre" value="<?php echo $info[$i][0] ?>">
											<?php echo $info[$i][0] ?>
										</td>
										<td class="mdl-data-table__cell--non-numeric">
											<input size="13" class="form-control input-sm" type="hidden" name="cedu_jefe" value="<?php echo $info[$i][2] ?>">
											<?php echo $info[$i][2] ?>
										</td>
										<td class="mdl-data-table__cell--non-numeric">
											<button class="btn btn-primary" data-toggle="modal" data-target=".<?php echo $i ?>" name="modificar" value="a"><em class="fa fa-plus"></em></button>
										</td>
									</tr>
								</form>
						...
						?>
							<form action="../include/agre_cuadrilla.php" method="POST">
								<tr style="display: none" id="nuevo">
									...
									<td class="mdl-data-table__cell--non-numeric"><input size="13" class="form-control input-sm" type="text" required="" name="nombre"></td>
									<td class="mdl-data-table__cell--non-numeric">
										<select name="cedu_jefe" class="form-control input-sm">
									...
									<td class="mdl-data-table__cell--non-numeric"><button type="submit" class="btn btn-primary" name="guardar">Guardar</button></td>
								</tr>
							</form>
						</tbody>
								</table>
								<br>
								<button type="button" class="btn btn-primary" id="button">Nueva cuadrilla</button> 
					</div>
				</div>
	...
	<?php
	?>
	<div class="modal fade <?php echo $i ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="exampleModalLabel">Integrantes de la cuadrilla</h5>
	      ...
	      <div class="modal-body">
			...
			<table class="table">
				...
				<tr>
					<td class="mdl-data-table__cell--non-numeric">
					<input size="13" class="form-control input-sm" type="text" name="rif" value="<?php echo $info[$i][0] ?>">	
					</td>
					<td class="mdl-data-table__cell--non-numeric">
