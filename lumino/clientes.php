...
<body>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<ul class="nav navbar-top-links navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
						<em class="fa fa-cog fa-lg fa-spin"></em><span class="label label-info"></span></a>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="clientes.php"><em class="fa fa-user">&nbsp;</em> Clientes</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			...
			<div align="center" class="mdl-cell mdl-cell--12-col">
		    		<h3 class="mdl-cell--hide-desktop" style="color:blue">Buscar clientes</h3>
					<div class="col-lg-2 col-lg-offset-5">
						<table>
							<form method="POST" id="formulario">
								<tr>
									<td>
							    		<input class="form-control" required maxlength="8" type="number" minlength="8" id="cedu" name="cedu">
							    	</td>
							    	<td>
							  			<button type="submit" class="fa fa-search fa-2x btn btn-primary" id="activador"></button>
							  		</td>
							  	</tr>
							</form>
						</table>
					...
					<div id="info" class="container-fluid table-responsive col-lg-8 col-md-offset-2" style="display: none"></div>
					<div class="container-fluid center-block">
						<div id="info_parcial" class="table-responsive col-lg-10 col-md-offset-1">
						<h3 style="color:grey" id="titulo">Fumigaciones por ejecutar</h3>
							...
							for ($i=0; $i < $aux; $i++) { 
								?>
										<tr>
											<td>
												<div>
													<input size="13" class="form-control input-sm" type="text" name="cedula" value="<?php echo $info[$i][0] ?>">
												</div>
											</td>
											<td class="mdl-data-table__cell--non-numeric">
												<div>
													<input size="13" class="form-control input-sm" type="text" name="nombre" value="<?php echo $info[$i][2] ?>">
												</div>
											</td>
											<td class="mdl-data-table__cell--non-numeric">
												<div>
													<input size="13" class="form-control input-sm" type="text" name="apellido" value="<?php echo $info[$i][3] ?>">
												</div>
											</td>
											<td class="mdl-data-table__cell--non-numeric">
												<div>
													<input size="13" class="form-control input-sm" type="text" name="direccion" value="<?php echo $info[$i][4] ?>">
												</div>
											</td>
											<td class="mdl-data-table__cell--non-numeric">
												<div>
													<input size="13" class="form-control input-sm" type="text" name="email" value="<?php echo $info[$i][5] ?>">
												</div>
											</td>
											<td class="mdl-data-table__cell--non-numeric">
												<div>
													<input size="13" class="form-control input-sm" type="text" name="telefono" value="<?php echo $info[$i][6] ?>">
												</div>
											</td>
										</tr>
								<?php
