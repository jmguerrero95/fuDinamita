...
$aux=count($info);
$datos2 = new SoapClient(null,array('location'=>'http://127.0.0.1/servicio_dinamita/proveedor.php','uri'=>'urn:proveedor',));
$info2=$datos2->consulta_rif();
$aux2=count($info2);
?>
<!DOCTYPE html>
<html>
		...
		<ul class="nav menu">
			...
			<li class="parent active"><a data-toggle="collapse" href="#sub-item-2">
				...
				<ul class="children collapse" id="sub-item-2">
					<li><a class="active" href="productos.php">
			...
			<li><a href="index.php"><em class="fa fa-power-off">&nbsp;</em>Cerrar sesión</a></li>
		</ul>
	</div><!--/.sidebar-->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<br/><br/><br/>
					...
					<div class="container-fluid center-block">
						<div id="info_parcial" class="table-responsive col-lg-12">
						...
						<?php
							for ($i=0; $i < $aux; $i++) { 
								?>
								<form method="POST" action="../include/acciones_produc.php">
										<tr>
											<td class="mdl-data-table__cell--non-numeric">
												<input class="form-control" size="10" type="text" name="nombre" value="<?php echo $info[$i][5] ?>">
											</td>
											<td class="mdl-data-table__cell--non-numeric">
												<input class="form-control" size="10" type="text" name="descripcion" value="<?php echo $info[$i][0] ?>">
											</td>
											<td class="mdl-data-table__cell--non-numeric">
												<input class="form-control" size="10" type="text" name="precio" value="<?php echo $info[$i][1] ?>">
											</td>
											<td class="mdl-data-table__cell--non-numeric">
												<input class="form-control" size="10" type="text" name="cantidad" value="<?php echo $info[$i][2] ?>">
											</td>
											<td class="mdl-data-table__cell--non-numeric">
												<input class="form-control" size="10" type="text" name="canti_mini" value="<?php echo $info[$i][3] ?>">
											</td>
											<td class="mdl-data-table__cell--non-numeric">
												<input class="form-control" size="10" type="text" name="rif" value="<?php echo $info[$i][4] ?>">
												<input class="form-control" size="10" type="hidden" name="codigo" value="<?php echo $info[$i][7] ?>">
											</td>
											<td class="mdl-data-table__cell--non-numeric">
											<button type="submit" class="btn btn-primary" name="modificar" value="a"><em class="fa fa-pencil fa-2x fa-spin"></em></button>
											<button type="submit" class="btn btn-primary" name="eliminar" value="b"><em class="fa fa-trash-o fa-2x fa-spin"></em></button>
										</td>
										</tr>
								</form>
								<?php
						...
						?>
								...
								<button type="button" id="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Nuevo producto</button>
					</div>
				</div>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	<form method="POST" action="../include/agre_produc.php">
		        <table class="table table-hover table-condensed">		
					<thead>
						<tr>
							<th class="mdl-data-table__cell--non-numeric">
					...
					<tbody>
						<tr>
							<td class="mdl-data-table__cell--non-numeric">
								<input size="13" required type="text" class="form-control input-sm" name="nombre">
							</td>
							<td class="mdl-data-table__cell--non-numeric">
								<textarea required class="form-control input-sm" rows="2" name="descripcion">	
								</textarea>
								
							</td>
							<td class="mdl-data-table__cell--non-numeric">
								<input size="13" required type="number" class="form-control input-sm" name="precio">
							</td>
						</tr>
						<tr>
							<th class="mdl-data-table__cell--non-numeric">
						...
						<tr>
							<td class="mdl-data-table__cell--non-numeric">
								<input size="13" required type="number" class="form-control input-sm" name="cantidad">
							</td>
							<td class="mdl-data-table__cell--non-numeric">
								<input size="13" required type="number" class="form-control input-sm" name="cant_mini">
							</td>
							<td class="mdl-data-table__cell--non-numeric">
								<select name="especialidad" class="form-control input-sm">
									...
									<?php
										for ($z=0; $z < $aux2; $z++) { 
												?>
													<option value="<?php echo $info2[$z][0] ?>"><?php echo $info2[$z][1] ?></option>
												<?php
										}
									?>
								</select>
				...
				<button type="submit" id="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Guardar</button>
			</form>
	      </div>
