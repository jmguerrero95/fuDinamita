...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class=""><a href="clientes.php"><em class="fa fa-user">&nbsp;</em> Clientes</a></li>
			...
			<li class="parent active"><a data-toggle="collapse" href="#sub-item-2">
				...
				<ul class="children collapse" id="sub-item-2">
					...
					<li><a class="active" href="proveedores.php">
					...
					<div id="info_parcial">
								...
								?>
									<form action="../include/acciones_provee.php" method="POST">
										<tr>
											...
											<td class="mdl-data-table__cell--non-numeric">
												<input size="13" class="form-control input-sm" type="text" name="nombre" value="<?php echo $info[$i][1] ?>">
											</td>
											<td class="mdl-data-table__cell--non-numeric">
												<input size="13" class="form-control input-sm" type="text" name="email" value="<?php echo $info[$i][2] ?>">
											</td>
											<td class="mdl-data-table__cell--non-numeric">
												<input size="13" class="form-control input-sm" type="text" name="num_tele" value="<?php echo $info[$i][3] ?>">
											</td>
											<td class="mdl-data-table__cell--non-numeric">
						...
						?>
								...
								<tr style="display: none" id="nuevo">
									<td><input size="13" class="form-control input-sm" type="text" name="rif"></td>
									<td><input size="13" class="form-control input-sm" type="text" name="nombre"></td>
									<td><input size="13" class="form-control input-sm" type="text" name="email"></td>
									<td><input size="13" class="form-control input-sm" type="text" name="num_tele"></td>
									<td><input size="13" class="form-control input-sm" type="text" name="direccion"></td>
									<td><button type="submit" class="btn btn-primary" name="guardar">Guardar</button></td>
								</tr>
							</form>
						</tbody>
								</table>
									...
									<br>
								<button type="button" class="btn btn-primary" id="button">Nuevo proveedor</button>
					</div>
				</div>
